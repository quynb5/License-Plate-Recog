...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("E:/Qt_Designer/ok_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.fr_input_img.setFrameShape(QtWidgets.QFrame.Box)
        self.fr_input_img.setFrameShadow(QtWidgets.QFrame.Plain)
        self.fr_input_img.setLineWidth(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.le_text_plate.setText(_translate("MainWindow", ""))
